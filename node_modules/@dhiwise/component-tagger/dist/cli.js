#!/usr/bin/env node
"use strict";var F=Object.create;var x=Object.defineProperty;var M=Object.getOwnPropertyDescriptor;var N=Object.getOwnPropertyNames;var I=Object.getPrototypeOf,O=Object.prototype.hasOwnProperty;var $=(e,t,r,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let l of N(t))!O.call(e,l)&&l!==r&&x(e,l,{get:()=>t[l],enumerable:!(o=M(t,l))||o.enumerable});return e};var p=(e,t,r)=>(r=e!=null?F(I(e)):{},$(t||!e||!e.__esModule?x(r,"default",{value:e,enumerable:!0}):r,e));var s=p(require("fs")),c=p(require("path")),S=p(require("fast-glob"));var f=p(require("chalk")),w=p(require("picomatch"));function i(e,t){if(!t.verbose)return;let r=e;e.includes("Error")||e.includes("error")?r=f.default.red(e):e.includes("Tagged")||e.includes("Summary")?r=f.default.green(e):e.includes("Processing")||e.includes("started")?r=f.default.blue(e):r=f.default.yellow(e),console.log(`[component-tagger] ${r}`)}function v(e){return`
(function() {
  // Configuration
  const CONFIG = {
...
`}function E(e={}){let t={extensions:[".html",".htm"],verbose:!1,attributePrefix:"data-component",includeContentAttribute:!0,maxContentLength:1e3,includeLegacyAttributes:!0,excludeDirectories:[],processNodeModules:!1,outputDir:"public",injectorScriptName:"dhws-data-injector.js",inspectorScriptName:"dhws-web-inspector.js",errorTrackerScriptName:"dhws-error-tracker.js",...e},r=process.cwd(),o={totalFiles:0,processedFiles:0,injectedFiles:0,scriptPath:""};i("HTML component tagger started",t);let l=v(t),d=c.resolve(r,e.outputDir||"public");s.existsSync(d)||(i(`Creating directory: ${d}`,t),s.mkdirSync(d,{recursive:!0}));let T=e.injectorScriptName||"dhws-data-injector.js",g=c.join(d,T);i(`Writing script to: ${g}`,t),s.writeFileSync(g,l),o.scriptPath=g;let C=`**/*{${t.extensions.join(",")}}`,b=S.default.sync(C,{cwd:r,ignore:["node_modules/**",...t.excludeDirectories.map(h=>`${h}/**`)]});return o.totalFiles=b.length,i(`Found ${b.length} HTML files to process`,t),b.forEach(h=>{let y=c.join(r,h),m=s.readFileSync(y,"utf8");o.processedFiles++;let G=(()=>{let u=c.relative(c.dirname(y),g).replace(/\\/g,"/");return!u.startsWith("/")&&!u.startsWith("../")?`/${u}`:u})(),L=m.includes("dhws-dataInjector"),A=`<script id="dhws-dataInjector" src="${G}"></script>`;if(L)i(`Script already injected in: ${h}`,t);else{o.injectedFiles++;let u=`${A}
`;m.includes("</body>")?m=m.replace("</body>",`${u}</body>`):m+=`
${u}`,s.writeFileSync(y,m)}}),i(`HTML component tagger completed:
  - Total files scanned: ${o.totalFiles}
  - Files processed: ${o.processedFiles}
  - Files with script injected: ${o.injectedFiles}
  - Script location: ${o.scriptPath}`,t),o}var n=process.argv.slice(2),a={};for(let e=0;e<n.length;e++)n[e]==="--verbose"||n[e]==="-v"?a.verbose=!0:n[e]==="--output-dir"&&n.length>e+1?(a.outputDir=n[e+1],e++):n[e]==="--injector-script-name"&&n.length>e+1?(a.injectorScriptName=n[e+1],e++):n[e]==="--attribute-prefix"&&n.length>e+1?(a.attributePrefix=n[e+1],e++):n[e]==="--inspector-script-name"&&n.length>e+1&&(a.inspectorScriptName=n[e+1],e++);try{let e=E(a);i("[component-tagger] Summary:",a),i(`  - Total HTML files found: ${e.totalFiles}`,a),i(`  - Files processed: ${e.processedFiles}`,a),i(`  - Files with script injected: ${e.injectedFiles}`,a),i(`  - Script location: ${e.scriptPath}`,a)}catch(e){e instanceof Error&&console.error(`[component-tagger] Error: ${e.message}`),process.exit(1)}
